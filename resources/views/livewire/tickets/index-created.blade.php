        ...
        <div class="flex flex-row justify-center">
            <div class="bg-blue-100 w-3/4 max-w-7xl shadow-md">
                <div class="flex flex-row justify-between">
                    <p class="font-semibold text-2xl mx-7 my-3">Created tasks</p>
...
{{--    search--}}
    ...
    @livewire('tickets.index-filter-created')
{{--    list tickets--}}
    <div class="md:mx-10 sm:mx-0 flex flex-col justify-center space-y-6">
        @foreach($tickets as $ticket)
            <div class="flex flex-row justify-between bg-green-100  rounded-xl shadow-xl">
                ...
                <div class="basis-1/6 flex flex-row justify-center flex-wrap bg-blue-100 p-4 rounded-r-xl">
                    <a href="{{route('manage', $ticket->id)}}" class="w-20 h-12 m-2 text-white bg-green-500 hover:bg-green-600 font-bold rounded-xl shadow-md grid place-content-center">
