{{--
    ...
    File: show-public.blade.php
    Subject: ITU 2022

    @author: Vladisalav Khrisanov(xkhris00)
--}}
{{--public view of the ticket--}}
<div>
...
{{--                        button area--}}
                        <div class="flex flex-row justify-center space-x-4 mb-5">
                            ...
                            <button wire:click="deleteComment" class="py-1 px-2 w-20 h-12 text-xl text-white bg-red-500 hover:bg-red-600 font-bold rounded-lg shadow-md" type="submit">
                                Yes
                            </button>
                        </div>
                    </div>
...
{{--                    button area--}}
                    <div class="flex flex-row justify-center space-x-4 m-6">
                        ...
                        <button wire:click="updateComment" class="py-1 px-2 w-24 h-12 text-xl text-white bg-green-500 hover:bg-green-600 font-bold rounded-lg shadow-md" type="submit">
                            Change
                        </button>
                    </div>
                </div>
...
{{--        main menu and the header--}}
        <div class="sticky @if(!$deleteHidden or !$changeHidden) hidden @endif top-0 ">
                ...
                <div class="bg-blue-100 w-3/4 max-w-7xl shadow-md">
                    <div class="bg-blue-100 flex flex-row flex-wrap mx-5 mb-1">
                        ...
                        @if($my_id != $ticket->user_id)
                            <button wire:click.prevent="startChatAuthor" class="w-44 h-8 m-2 text-white bg-yellow-500 hover:bg-yellow-600 font-bold rounded-xl shadow-md">
                                Message the author
                            </button>
                        <button wire:click.prevent="invitationForm" class="w-20 h-8 m-2 text-white bg-green-500 hover:bg-green-600 font-bold rounded-xl shadow-md">
                            Take
                        </button>
                        @endif
                    </div>
...
{{--        invitation form for the ticket--}}
...
{{--                comments--}}
                <div class="basis-1/2 h-full">
                    <div class="flex flex-col h-full">
                        <p class="bg-white font-semibold text-lg p-2 rounded-t-xl  shadow-md">Comments</p>
                        <div id="chatWindow" class="bg-blue-100 basis-8/12 overflow-scroll overscroll-contain shadow-md">
                            ...
                            <div class="flex flex-col space-y-2 p-2 w-full">
                                @foreach($ticket->comments as $message)
                        ...
                        <div class="bg-white rounded-b-xl shadow-md">
                            <form wire:submit.prevent="sendComment" action="#">
                                <div class="flex flex-row space-x-2 p-2">
                                    <div class="basis-4/5 flex flex-col">
                                        <textarea wire:model.defer="commentContent" class="resize-y bg-slate-100 rounded-2xl pt-3 px-3" placeholder="Write a comment.."></textarea>
                                    </div>
